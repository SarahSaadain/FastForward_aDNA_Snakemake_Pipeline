...
_scg_sel_settings      = config.get("pipeline", {}).get("reveal_module", {}).get("scg_selector", {}).get("settings", {})
_dyn_settings          = config.get("pipeline", {}).get("reveal_module", {}).get("mapping", {}).get("settings", {})
...
if _scg_sel_mapper == "minimap2":
    ...
    rule index_scg_library_for_mapping_bwa_aln:
        ...
        output:
            multiext("{species}/processed/reveal_module/scg/{species}_scg_library.fasta", ".amb", ".ann", ".bwt", ".pac", ".sa"),
        log:
    ...
    rule map_reads_to_scg_library_bwa_aln:
        input:
            ...
            idx=multiext("{species}/processed/reveal_module/scg/{species}_scg_library.fasta", ".amb", ".ann", ".bwt", ".pac", ".sa"),
        output:
            temp("{species}/processed/reveal_module/scg/reads_mapped/{individual}_scg_library.unsorted.with_unmapped.bam"),
        log:
