...
if _dyn_mapper == "minimap2":
    ...
    rule index_library_for_mapping_bwa_aln:
        ...
        output:
            multiext("{species}/processed/reveal_module/{feature_library}/library/{feature_library}_and_scg.suffixed.fasta", ".amb", ".ann", ".bwt", ".pac", ".sa"),
        log:
    ...
    rule map_reads_to_scg_feature_library_bwa_aln:
        input:
            ...
            idx=multiext("{species}/processed/reveal_module/{feature_library}/library/{feature_library}_and_scg.suffixed.fasta", ".amb", ".ann", ".bwt", ".pac", ".sa"),
        output:
            temp("{species}/processed/reveal_module/{feature_library}/mapped/{individual}_{feature_library}_and_scg.unsorted.with_unmapped.bam"),
        log:
